...
public class PageRank {
    ...
    public List<Double> calculate(Matrix storage) {
    ...
    private void init(Matrix storage) {
     ...
     private double diff(List<Double> ranks, List<Double> prevRanks) {
    ...
    private double[] toArray(List<Double> ranks) {
